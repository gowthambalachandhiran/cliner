...
def enabled_modules():
    ...
    """
    # Open config file
    filename = os.path.join(r'C:\Users\balacg1\Desktop\Cliner', 'config.txt' )
    f = open(r'C:\Users\balacg1\Desktop\Cliner\config.txt', 'r')
    ...
    specs["UMLS"] = r'C:\Users\balacg1\Desktop\Cliner\umls_tables'
